...
class _JoinScreenState extends State<JoinScreen> {
  ...
  void initState() {
    ...
    // Check if socket is not null before adding listener
    ...
    if (socket != null) {
      ...
      // Optionally, handle the case where socket is null (e.g., log or show error)
      debugPrint('SignallingService socket is null in JoinScreen.initState');
    }
  }
